...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backend/images/logo-white 2.png') }}">

    <title>Dr.farm Admin - Log in </title>
							...
							<form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="ایمیل">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="رمزعبور">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
